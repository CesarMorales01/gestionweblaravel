                            ...
                            <div className="hidden space-x-8 md:-my-px md:ml-10 md:flex ">
                                <div className='rounded' style={{ zIndex: '9', marginTop: '1em', borderRadius: '15px' }} >
                                    ...
                                    <div style={{ borderRadius: '15px' }} className="hidden peer-hover:flex hover:flex flex-col bg-white drop-shadow-lg">
                                        ...
                                        <a style={{ color: globalVars.info == null ? 'black' : globalVars.info.color_letra_navbar, padding: '0.5em' }} className="tamañoLetraNav btn btn-outline-light text-left hover:bg-gray-200" href={route('promo.index')} active={route().current('promo.index')}>Carrusel</a>
