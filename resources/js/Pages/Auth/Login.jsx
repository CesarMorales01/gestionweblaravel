        ...
        <GuestLayout globalVars={globalVars}>
            ...
            <form id='formLogin' onSubmit={submit}>
                ...
                <div className="flex items-center justify-end mt-4">
                    ...
                    <button onClick={goLogin} id='btnLogin' style={{ backgroundColor: globalVars.info == null ? 'gray' : globalVars.info.color_pagina, color: globalVars.info == null ? 'black' : globalVars.info.color_letra_navbar }} className="ml-4 btn btn-primary" disabled={processing}>
                        Entrar
                    </button>
