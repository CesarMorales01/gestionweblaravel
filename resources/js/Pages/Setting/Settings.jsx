                ...
                <form onSubmit={fetchIngresarDatos} method="POST" id="formCrear" action={route('setting.store')} encType="multipart/form-data">
                    <div className="row justify-content-around">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-12" >
                            ...
                            <input style={{ cursor: 'pointer' }} name='color_letra_navbar' type="color" className="form-control form-control-color" onChange={cambiarColorLetra} value={datosPagina.color_letra_navbar} title="Choose your color" />
                            <br />
