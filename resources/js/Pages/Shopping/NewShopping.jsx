            ...
            <div className="container">
                ...
                <div style={{ marginTop: '0.2em' }} className='row justify-content-center'>
                    <div className='col-lg-6 col-md-6 col-sm-12 col-12'>
                        ...
                        <input className='rounded' type="date" onChange={cambioFecha} name="fecha" id="inputDate" />
                        <br />
                        ...
                        <textarea style={{ marginTop: '0.4em' }} name='comentario_cliente' placeholder='Comentario cliente...' onChange={cambioComentarioCliente} className="form-control rounded" value={datosCompra.comentario_cliente}></textarea>
