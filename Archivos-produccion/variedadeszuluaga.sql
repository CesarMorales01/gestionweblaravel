...
-- Tiempo de generación: 08-11-2023 a las 20:15:26
...
--
-- Base de datos: `variedadeszuluaga`
--
...
CREATE TABLE `carrito_compras` (
  ...
  `cantidad` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `subtotal` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `categorias_gastos` (`id`, `nombre`) VALUES
(4, 'Servicio publicos');
...
INSERT INTO `categorias_ingresos` (`id`, `nombre`) VALUES
...
INSERT INTO `categorias_proveedores` (`id`, `nombre`) VALUES
(10, 'Proveedor 1');
...
CREATE TABLE `clientes` (
  `id` int NOT NULL,
  `cedula` varchar(50) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `nombre` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `apellidos` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT '',
  `direccion` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `info_direccion` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `telefono` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `ciudad` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `departamento` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `fecha_ingreso` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT '',
  `otros` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT ''
...
INSERT INTO `clientes` (`id`, `cedula`, `nombre`, `apellidos`, `direccion`, `info_direccion`, `telefono`, `ciudad`, `departamento`, `fecha_ingreso`, `otros`) VALUES
(15, NULL, 'Cesar', NULL, NULL, NULL, NULL, NULL, NULL, '2023-11-08', NULL);
...
CREATE TABLE `gastos` (
  ...
  `valor` int NOT NULL,
  `comentario` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `gastos` (`id`, `fecha`, `category_id`, `valor`, `comentario`) VALUES
(3, '2023-09-23', 4, 65000, NULL);
...
CREATE TABLE `imagenes_productos` (
  `id` int NOT NULL,
  `nombre_imagen` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `info_pagina` (
  ...
  `descripcion_pagina` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `direccion_pagina` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color_pagina` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color_letra_navbar` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `correo` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linkfb` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linkinsta` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `comision_pasarela_pagos` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `valor_envio` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `valor_pago_contraentrega` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `info_pagina` (`id`, `nombre`, `descripcion_pagina`, `direccion_pagina`, `color_pagina`, `color_letra_navbar`, `correo`, `linkfb`, `linkinsta`, `logo`, `imagen`, `comision_pasarela_pagos`, `valor_envio`, `valor_pago_contraentrega`) VALUES
(22, 'Sjv', NULL, NULL, '#07d3ed', '#fb0404', 'cezar_mh86@hotmail.com', NULL, NULL, 'free-online-shopping-342-910324.png', '328242807_460414309511238_5671903979734079247_n.jpg', '0', '0', '0');
...
INSERT INTO `ingresos` (`id`, `fecha`, `category_id`, `valor`, `comentario`) VALUES
(4, '2023-09-23', 4, '06000', NULL),
(5, '2023-08-30', 4, '06000', NULL);
...
INSERT INTO `keys` (`id`, `name`, `cedula`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(24, 'Cesar', '15', NULL, NULL, '$2y$10$fZG9vXiYejTDd0NuOWmcOOXuiajEEtA7zD4l2k1XeWYtPSmes5Nmq', NULL, NULL, NULL);
...
CREATE TABLE `lista_compras` (
  `id` bigint UNSIGNED NOT NULL,
  `cliente` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `comentario_cliente` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `compra_n` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `fecha` date NOT NULL,
  `total_compra` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `domicilio` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `medio_de_pago` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `costo_medio_pago` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comentarios` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dinerorecibido` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cambio` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Entregada',
  `vendedor` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `lista_compras` (`id`, `cliente`, `comentario_cliente`, `compra_n`, `fecha`, `total_compra`, `domicilio`, `medio_de_pago`, `costo_medio_pago`, `comentarios`, `dinerorecibido`, `cambio`, `estado`, `vendedor`) VALUES
(74, '', '', '1', '2023-11-08', '198', '0', 'Efectivo', '0', '', '', '', 'Recibida', 'Delcy'),
(75, '', '', '1', '2023-11-08', '99', '0', 'Efectivo', '0', '', '', '', 'Recibida', 'Delcy');
...
CREATE TABLE `lista_productos_comprados` (
  ...
  `cliente` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `compra_n` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `codigo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `producto` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `cantidad` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `precio` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `lista_productos_comprados`
--

INSERT INTO `lista_productos_comprados` (`id`, `fk_compra`, `cliente`, `compra_n`, `codigo`, `producto`, `descripcion`, `cantidad`, `precio`) VALUES
(78, 74, NULL, '1', '20', 'Ejemplo 1', '', '2', '99'),
(79, 75, NULL, '1', '20', 'Ejemplo 1', '', '1', '99');
...
(28, '2023_05_23_191558_create_keys_table', 1),
(42, '2023_05_12_203401_create_sessions_table', 2),
(51, '2014_10_12_000000_create_users_table', 3),
(52, '2014_10_12_100000_create_password_reset_tokens_table', 3),
...
--
-- Estructura de tabla para la tabla `pagos_wompi`
--

CREATE TABLE `pagos_wompi` (
  `id` bigint UNSIGNED NOT NULL,
  `ref_wompi` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cliente` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `valor_compra` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `preguntas_sobre_productos` (
  `id` int NOT NULL,
  `fecha` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cliente` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `producto` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pregunta` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `respuesta` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `productos` (
  `id` bigint UNSIGNED NOT NULL,
  `referencia` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `category_id` bigint DEFAULT NULL,
  `subcategoria` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `costo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `promociones` (
  ...
  `ref_producto` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `proveedores` (`id`, `fecha`, `nombre`, `descripcion`, `categoria`, `valor`) VALUES
(12, '2023-09-23', 'Pedido 1', NULL, 10, '65000');
...
(1, 'Delcy', 'jusamstore@gmail.com', NULL, '$2y$10$pj7fjxsqhoF.Bo8zBJA/feL17L1fNBXVr3dtgkBIbhyazB6VKJrNS', NULL, '2023-11-08 06:55:30', '2023-11-08 06:55:30');
...
ALTER TABLE `ingresos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ingresos_category_id_foreign` (`category_id`);
...
ALTER TABLE `keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `keys_email_unique` (`email`);
...
--
-- Indices de la tabla `pagos_wompi`
--
ALTER TABLE `pagos_wompi`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `municipios`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1127;

--
-- AUTO_INCREMENT de la tabla `pagos_wompi`
--
ALTER TABLE `pagos_wompi`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ingresos`
  ADD CONSTRAINT `ingresos_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categorias_ingresos` (`id`);
...
--
ALTER TABLE `proveedores`
  ADD CONSTRAINT `proveedores_ibfk_1` FOREIGN KEY (`categoria`) REFERENCES `categorias_proveedores` (`id`);
COMMIT;
